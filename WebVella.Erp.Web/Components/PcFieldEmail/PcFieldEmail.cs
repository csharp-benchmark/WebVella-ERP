...
{
	[PageComponent(Label = "Field Email", Library = "WebVella", Description = "An email can be entered by the user, which will be validated and presented accordingly", Version = "0.0.1", IconClass = "far fa-envelope")]
	public class PcFieldEmail : PcFieldBase
	{
		protected ErpRequestContext ErpRequestContext { get; set; }

		public PcFieldEmail([FromServices]ErpRequestContext coreReqCtx)
		{
			ErpRequestContext = coreReqCtx;
		}

		public class PcFieldEmailOptions : PcFieldBaseOptions
		{
		...
		public async Task<IViewComponentResult> InvokeAsync(PageComponentContext context)
		{
			...
			try
			{
				...
				var options = PcFieldEmailOptions.CopyFromBaseOptions(baseOptions);
